package nightshadow404.Cannoneer.reference;


public class reference {

    public static final String Mod_ID = "N404Cannoneer";
    public static final String Mod_NAME = "nightshadow404's Cannoneer";
    public static final String Mod_VERSION = "1.7.2-0.1a";
